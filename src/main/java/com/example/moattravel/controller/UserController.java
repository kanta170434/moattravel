...
public class UserController {
    ...
    @GetMapping("/edit")
    public String edit(@AuthenticationPrincipal UserDetailsImpl userDetailImpl, Model model) {
        User user = userRepository.getReferenceById(userDetailImpl.getUser().getId());
